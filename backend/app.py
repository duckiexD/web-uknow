...
try:
    from models import (
        init_db, get_db, save_order,
        get_comments, save_comment, like_comment,
        save_gym_order, save_rent_order
    )
...
def serve_index():
    ...
    try:
        ...
        return f"Ошибка: {e}. Проверьте, что файл index.html существует в папке frontend", 404
